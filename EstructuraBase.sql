...
CREATE TABLE IF NOT EXISTS `Secciones` (
  ...
  PRIMARY KEY (`ID`),
  FOREIGN KEY (`ContenidoID`) REFERENCES `Contenidos` (`ID`) ON DELETE CASCADE,
  FOREIGN KEY (`AtajoID`) REFERENCES `Contenidos` (`ID`) ,
  FOREIGN KEY (`TituloID`) REFERENCES `Contenidos` (`ID`) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS `Menu` (
  ...
  `UrlIconID` int(11) DEFAULT NULL,
  `PrioridadesGrpID` int(11) DEFAULT NULL,
  `Visible` tinyint(1) DEFAULT NULL,
  `TagsGrpID` int(11) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  FOREIGN KEY (`ContenidoID`) REFERENCES `Contenidos` (`ID`) ON DELETE CASCADE,
  FOREIGN KEY (`UrlID`) REFERENCES `Contenidos` (`ID`) ON DELETE CASCADE,
  FOREIGN KEY (`UrlIconID`) REFERENCES `Contenidos` (`ID`) ON DELETE CASCADE,
