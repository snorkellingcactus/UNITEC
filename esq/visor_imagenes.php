...
<div class="col-lg-10 col-md-10 col-sm-10 col-xs-8 imgCont">
		<a href="visor.php?vRec=<?php echo $this->vRecAnt ?>" class="flecha" title="Imagen Anterior" >
			<img src="../img/flecha_i.png" alt="Flecha hacia la izquierda"/>
		</a>

		<img src="<?php echo $this->Url ?>" alt="<?php echo $this->AltCon ?>"/>					

		<a href="visor.php?vRec=<?php echo $this->vRecSig ?>"  class="flecha" title="Imagen Siguiente">
