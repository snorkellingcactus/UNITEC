<div class="contenedor">
	<form action="php/accion.php" method="POST" target="_blank" class="col-xs-12 col-sm-7 sm-6 col-md-6 col-lg-6">
		<h1 class="col-xs-12 col-xs-offset-0 col-all-offset-5 col-all-7 all-12 all-offset-0">
		...
		<div class="clearfix"></div>
		<div class="label">
			<input type="submit" name="nuevo" value="<?php echo gettext('Enviar')?>" class="col-xs-12 col-xs-offset-0 col-all-offset-5 col-all-7 all-12 all-offset-0">
		</div>
	</form>
</div>
<div class="col-xs-12 col-sm-3 col-md-2 col-lg-2 social contenedor">
	<a href="https://www.facebook.com/uid.unitec?fref=ts">
			<img alt="<?php echo gettext('Página de Facebook')?>" src="/img/Facebook.png">
	</a>
	<a href="#">
		<img alt="<?php echo gettext('Página de Twitter')?>" src="/img/Twitter.png">
	</a>
</div>
<div class="clearfix"></div>
