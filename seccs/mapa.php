...
<div class="contenedor">
    <img id="map-canvas" src="https://maps.googleapis.com/maps/api/staticmap?center=-34.90693 , -57.94290&zoom=17&size=500x500&maptype=roadmap
&markers=color:red%7Clabel:A%7C-34.90693 , -57.94290&key=AIzaSyAc98zfTPT0nZTSERA7bEgBdPiyI6kM6hk" alt="Mapa de la ubicación de unitec">
</div>
...
<!--    <h3>¿Cómo Llegar?</h3> -->
    ...
    <form class="col-xs-12 col-sm-12 col-md-12 col-lg-12" action="php/accion.php" method="POST">
        ...
        <input type="text" id="origen" name="origen" placeholder="Calle, Ciudad , Estado"  class="col-xs-12 col-sm-7 col-md-7 col-lg-7">
        <p class="gris col-xs-12 col-sm-7 col-md-7 col-md-offset-5 col-sm-offset-5 col-lg-7 col-lg-offset-5">Ej : Av 1 y 60, La Plata</p>

        <input type="hidden" name="form" value="accionesMaps">
        <input type="submit" class="submit" id="buscar" value="Buscar ruta" name="nuevo">
    </form>
</div>